...
DPGP_output = '02-DP_GP/DTW-K{}DPGP_output/DTW-K{}-Cluster{}_optimal_clustering.txt'
...
for i in range(1,args.Kval+1):
    print(args.Kval,i)
    df = pd.read_csv(DPGP_output.format(args.Kval,args.Kval,i),sep='\t',index_col='cluster')
